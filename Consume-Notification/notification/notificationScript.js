...
const notificationSent = db.notificationSent;

const clientId = process.env.KAFKA_CLIENT_ID;
const brokers = [process.env.BROKER_IP];
const topic = process.env.KAFKA_TOPIC2;
const topic2 = process.env.KAFKA_TOPIC;
    ...
    return new Promise(async (resolve, reject) => {
      ...
      await consumer.run({
        ...
        eachMessage: async ({ message }) => {
          ...
          await notificationSent.create(JSON.parse(message.value.toString()));
